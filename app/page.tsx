  ...
  return (
    <MaxWidthWrapper className='mb-12 flex mt-28 flex-col items-center justify-center text-center'>
      ...
      <h1 className='sm:text-3xl text-xl font-black text-center max-w-2xl'>
        <span className='text-red-400'>Qu&apos;es que tu veux faire plus tard ?</span>
        <span className='font-normal mt-2 block'>On t&apos;aide à y repondre une bonne fois pour toute, <span className='underline'>simplement</span> et <span className='underline'>efficacement</span> !</span>
      </h1>
      <div className="flex mt-6 gap-4">
        <Button>Commencer</Button>
        <Button variant="outline">Je </Button>
      </div>
    </MaxWidthWrapper>
  )
}
